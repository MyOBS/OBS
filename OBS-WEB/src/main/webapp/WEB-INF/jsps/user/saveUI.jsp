...
<div id="Title_bar">
    <div id="Title_bar_Head">
        ...
        <div id="Title"><!--页面标题-->
            <img border="0" width="13" height="13" src="${basePath}style/images/title_arrow.gif"/> 用户信息
        </div>
...
<div id=MainArea>
    ...
    <s:form action="user_%{id == null ? 'add' : 'edit'}">
        ...
        <div class="ItemBlock_Title1"><!-- 信息说明 --><div class="ItemBlock_Title1">
        	<img border="0" width="4" height="7" src="${basePath}style/blue/images/item_point.gif" /> 用户信息 </div> 
        </div>
		...
		<div class="ItemBlock_Title1"><!-- 信息说明 --><div class="ItemBlock_Title1">
        	<img border="0" width="4" height="7" src="${basePath}style/blue/images/item_point.gif" /> 岗位设置 </div> 
        </div>
